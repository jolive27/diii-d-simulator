...
export default function Home(){
 ...
 return <main><header><div className="wordmark"><Activity size={25}/><span>DIII-D <b>/ VIRTUAL SHOT</b></span></div><a href="/validation" style={{color:"#8fe5d4",fontSize:13}}>Verification dashboard →</a><span className="tag">EDUCATIONAL MODEL · MILESTONE 02</span></header>
