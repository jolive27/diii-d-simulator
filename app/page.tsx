...
export default function Home(){
 ...
 return <main><header><div className="wordmark"><Activity size={25}/><span>DIII-D <b>/ VIRTUAL SHOT</b></span></div><span className="tag">EDUCATIONAL MODEL · MILESTONE 01</span></header>
